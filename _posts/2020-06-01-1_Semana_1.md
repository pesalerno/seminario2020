...
> 
> **Fecha de entrega:** MIERCOLES 10 junio 11:59pm 
> 
...
Para comenzar a desarrollar sus guías del proyecto en MarkDown, bajen el [archivo original de este documento](https://github.com/pesalerno/seminario2020/blob/master/_posts/2020-06-01-1_Semana_1.md) que estan leyendo para copiar/pegar el formato de entrega de nombre/titulo/etc. Al hacer click en los vinculos de los archivos en github, deben hacer click en `Raw` para visualizar (y copiar/pegar) el codigo directo desde la web.  
